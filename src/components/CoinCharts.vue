    ...
    <div class="info-card">
        <div class="row">
            <div class="col-12  align-items-center">
                <div class="row chart-bar">
                    <div class="chart-type">
                        <button class="btn btn-primary btn-sm mr-2" :class="[{'active': chartType==='cs'}]" @click="toCandleStickChart">Свечной график</button>
                        <button class="btn btn-primary btn-sm" :class="[{'active': chartType==='lc'}]" @click="toLineChart">Линейный график</button>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 p-2 text-right">
                <button class="btn btn-primary btn-sm mr-2" :class="[{'active': interval==='1h'}]" @click="updateTimeInterval('1h')">Один Час</button>
                <button class="btn btn-primary btn-sm mr-2" :class="[{'active': interval==='1d'}]" @click="updateTimeInterval('1d')">Один День</button>
                <button class="btn btn-primary btn-sm mr-2" :class="[{'active': interval==='1w'}]" @click="updateTimeInterval('1w')">Одна Неделя</button>
                <button class="btn btn-primary btn-sm mr-2" :class="[{'active': interval==='1M'}]" @click="updateTimeInterval('1M')">Один месяц</button>
            </div>
        </div>
  ...
  export default {
    ...
    methods: {
      ...
      fetchChartData(isUpdate = false) {
        ...
        const apiurl = `https://api.binance.com/api/v3/klines?symbol=${this.symbol}&interval=${this.interval}`;
        fetch(apiurl).then(
          function (response) {
